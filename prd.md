...
| Tab | 中文名 | 英文名 | 图标 | 说明 |
|-----|-------|-------|------|------|
| 1 | 首页 | Home | ri-home-5-line/fill | 行情概览+新闻 |
| 2 | 行情 | Quotes | ri-line-chart-line/fill | 贵金属详细行情 |
| 3 | 外汇 | FX | ri-exchange-dollar-line/fill | 汇率换算+货币对 |
| 4 | 社区 | Community | ri-discuss-line/fill | 讨论区+话题 |
| 5 | 我的 | Profile | ri-user-3-line/fill | 个人中心 |
...
首页作为App的入口，提供全局行情概览和最新资讯，让用户快速获取黄金、白银、主要汇率品种的实时信息，以及市场相关新闻动态。
...
行情页提供贵金属、外汇、加密货币、股指等多类资产的详细行情列表，支持分类筛选和自选功能，用户可查看更多品种的详细信息。
...
│  │  伦敦金                                                   │ │
│  │  ┌─────┐                                                 │ │
│  │  │LBMA │  [迷你走势图]    $1,850.50   +$12.30  +0.67%   │ │
│  │  └─────┘                                                 │ │
│  └──────────────────────────────────────────────────────────┘ │
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  纽约金                                                   │ │
│  │  ┌─────┐                                                 │ │
│  │  │COMEX│  [迷你走势图]    $1,852.00   +$10.50  +0.57%   │ │
│  │  └─────┘                                                 │ │
│  └──────────────────────────────────────────────────────────┘ │
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  纸黄金                                                   │ │
│  │  ┌───┐                                                   │ │
│  │  │SGE│   [迷你走势图]    ¥614.50     +¥3.20   +0.52%   │ │
│  │  └───┘                                                   │ │
│  └──────────────────────────────────────────────────────────┘ │
│                                                                │
│  白银 & 其它                                                   │  ← 分组标题
...
│  │  伦敦银                                                   │ │
│  │  ┌─────┐                                                 │ │
│  │  │LBMA │  [迷你走势图]    $24.15      -$0.12   -0.50%   │ │
│  │  └─────┘                                                 │ │
│  └──────────────────────────────────────────────────────────┘ │
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  纽约银                                                   │ │
│  │  ┌─────┐                                                 │ │
│  │  │COMEX│  [迷你走势图]    $24.20      -$0.08   -0.33%   │ │
│  │  └─────┘                                                 │ │
│  └──────────────────────────────────────────────────────────┘ │
│                                                                │
├────────────────────────────────────────────────────────────────┤
...
|-----|------|
| 品种名称 | 中文名称（如：伦敦金） |
| 市场标签 | 小标签显示市场来源（LBMA/COMEX/SGE） |
| 迷你走势图 | 显示近期价格趋势的简化折线图 |
| 当前价格 | 实时价格，带货币符号 |
| 涨跌额 | 较昨收价格变化值 |
| 涨跌幅 | 较昨收涨跌百分比，带颜色标识 |
...
- [ ] 顶部导航栏显示返回、标题、搜索、设置
- [ ] 分类chips可横向滚动，选中态正确显示
- [ ] 行情列表按分组显示，带分组标题
- [ ] 每个列表项显示迷你走势图
- [ ] 市场标签正确显示（LBMA/COMEX/SGE）
- [ ] 涨跌颜色正确显示
- [ ] 点击列表项正确跳转详情页
- [ ] 推广卡片正确显示
...
外汇页提供主要货币对的实时汇率展示，并集成双向货币兑换计算器，方便用户快速进行货币换算。页面包含货币转换工具和热门货币对行情列表。
...
| 元素 | 说明 |
|-----|------|
| 源货币区域 | 国旗图标 + 货币代码 + 货币名称 + 金额输入框 |
| 切换按钮 | 圆形按钮，点击交换源货币和目标货币 |
| 目标货币区域 | 国旗图标 + 货币代码 + 货币名称 + 计算结果 |
| 汇率显示 | 显示当前汇率和更新时间 |
| 卡片样式 | 圆角卡片，白色背景，轻微阴影 |
...
|-----|------|
| 双国旗图标 | 显示货币对的两个国家国旗 |
| 货币对名称 | 如：EUR/USD、GBP/USD |
| 货币对中文名 | 如：欧元/美元、英镑/美元 |
| 迷你走势图 | 显示近期价格趋势的简化折线图 |
| 当前汇率 | 实时汇率价格 |
| 涨跌幅标签 | 圆角标签，绿色上涨/红色下跌 |
...
详情页是所有品种（黄金、白银、货币、股指等）的通用详情展示页面，包含实时价格、数据面板、K线图表和独特的"价格锚定评论区"功能。这是本产品的核心差异化功能。

#### 4.4.2 页面布局

```
┌────────────────────────────────────────────────────────────────┐
│  ←    苹果公司 AAPL    ● 交易中    [USD ▼]    ☆               │  ← 顶部导航栏
│  (返回)                (市场状态)  (货币选择) (收藏)            │
├────────────────────────────────────────────────────────────────┤
│                                                                │
│         $178.50                                                │  ← 主价格
...
│  │  ┌────────────────────────────────────────────────────┐  │ │
│  │  │  📊 黄金 XAU/USD                                    │  │ │
│  │  │  $1,850.30  ▲ +0.67%                               │  │ │  ← 品种涨跌卡片
│  │  └────────────────────────────────────────────────────┘  │ │
│  │  ┌────────────────────────────────────────────────────┐  │ │
│  │  │  💰 评论时价格: $1,848.50                           │  │ │  ← 价格锚定标签
│  │  └────────────────────────────────────────────────────┘  │ │
│  │                                                          │ │
│  │  感觉要突破1860了，准备加仓！                             │ │
│  │                                                          │ │
...
|-----|------|------|
| 返回按钮 | 左侧 | 返回上一页 |
| 品种名称 | 中间偏左 | 显示品种中文名+代码（如：苹果公司 AAPL） |
| 市场状态 | 中间 | 绿点+文字显示交易状态（交易中/休市） |
| 货币选择 | 右侧 | 下拉选择显示货币（USD/CNY等） |
| 收藏按钮 | 右侧 | 点击收藏/取消收藏 |
...
| 元素 | 说明 |
|-----|------|
| "去讨论"按钮 | 主按钮，点击滚动到讨论区或进入讨论详情页 |
| 通知按钮 | 订阅该品种的价格提醒和讨论通知 |

#### 4.4.9 底部评论输入栏

| 元素 | 说明 |
|-----|------|
| 当前价格显示 | 实时显示当前价格，发布时自动锚定 |
| 输入框 | 占位文字"说点什么..." |
| 发送按钮 | 点击发布评论 |
...
| 点击返回 | 返回上一页 |
| 点击货币选择 | 弹出货币选择列表 |
| 点击收藏 | 收藏/取消收藏该品种，图标变化 |
| 点击"去讨论" | 滚动到讨论区或进入讨论详情页 |
| 点击通知按钮 | 订阅/取消订阅该品种通知 |
| 点击时间周期 | 切换K线图表周期 |
| 点击评论输入框 | 弹出键盘，显示当前价格 |
| 提交评论 | 捕获当前价格，发布评论 |
...
社区是内容聚合页面，展示热门话题、热门品种关注、热门评论以及**预测达人榜**，帮助用户发现有价值的讨论内容和优秀的预测达人。
...
| 图标 | 功能 | 说明 |
|-----|------|------|
| 🔍 搜索 | 搜索话题/用户/评论 | 点击进入搜索页面 |
| 📝 文章 | 我的文章 | 查看自己发布的内容 |
| 💬 消息 | 私信消息 | 查看私信列表 |
| 🔔 通知 | 系统通知 | 查看点赞、评论、关注等通知 |
...
新闻模块提供财经资讯浏览功能，包括新闻列表页和新闻详情页，帮助用户获取贵金属、外汇、加密货币等领域的最新资讯。
...
│  ←                    新闻列表                           🔍    │  ← 顶部导航栏
├────────────────────────────────────────────────────────────────┤
│  [全部] [贵金属] [外汇] [加密货币] [宏观经济] [大宗商品]        │  ← 分类筛选chips
│                                                                │     可横向滚动
├────────────────────────────────────────────────────────────────┤
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  ┌──────────────────────────────────────────────────────┐│ │
...
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  加密货币 · 42分钟前                                      │ │
│  │  比特币ETF资金流入量创单日新高，机构投资者    ┌────────┐│ │
│  │  加速入场布局                                  │  📷   ││ │
│  │  贝莱德IBIT基金单日增持超过1万枚比特币...     └────────┘│ │
│  │  CoinDesk                                                │ │
│  └──────────────────────────────────────────────────────────┘ │
│  ─────────────────────────────────────────────────────────────│
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  外汇 · 1小时前                                    ⋮     │ │  ← 纯文字新闻项
│  │  欧洲央行行长拉加德：抗击通胀尚未结束，核心通胀仍具粘性  │ │     无缩略图
│  │  尽管整体通胀率有所下降，但在服务业价格持续上涨的推动下..│ │
│  └──────────────────────────────────────────────────────────┘ │
│  ─────────────────────────────────────────────────────────────│
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  大宗商品 · 2小时前                                       │ │
│  │  OPEC+ 考虑延长减产协议至2025年，油价应声反弹 ┌────────┐│ │
│  │  ▲ WTI +2.1%  华尔街日报                      │  📷   ││ │
│  │                                               └────────┘│ │
│  └──────────────────────────────────────────────────────────┘ │
│                                                                │
...
├────────────────────────────────────────────────────────────────┤
│                                                                │
│  China's Factory Activity Unexpectedly Shrinks in             │  ← 新闻标题
│  October, Raising Economic Concerns                           │     大字加粗
│                                                                │
│  2023-10-31 09:00 - Reuters                                   │  ← 发布时间+来源
│                                                                │
├────────────────────────────────────────────────────────────────┤
│                                                                │
│  China's manufacturing activity unexpectedly contracted       │  ← 正文内容
│  in October, an official factory survey showed on Tuesday,    │
│  renewing concerns about the outlook for the world's          │
...
│  │                                                          │ │     16:9比例
│  └──────────────────────────────────────────────────────────┘ │
│  Factory production line in southern China.                   │  ← 图片说明
│                                                                │
│  The latest data clouds the outlook for the economy...        │
│                                                                │
├────────────────────────────────────────────────────────────────┤
│  ─────────────────────────────────────────────────────────────│
├────────────────────────────────────────────────────────────────┤
│  相关新闻                                                      │  ← 相关新闻区域
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  Global Markets React to U.S. Fed's Latest    ┌────────┐│ │
│  │  Interest Rate Decision                       │  📷   ││ │
│  │  Bloomberg · 2h ago                           └────────┘│ │
│  └──────────────────────────────────────────────────────────┘ │
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  Tech Sector Sees Record Investment In Q3     ┌────────┐│ │
│  │  Despite Headwinds                            │  📷   ││ │
│  │  TechCrunch · 5h ago                          └────────┘│ │
│  └──────────────────────────────────────────────────────────┘ │
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  European Central Bank Signals Caution on     ┌────────┐│ │
│  │  Future Policy Moves                          │  📷   ││ │
│  │  Reuters · 8h ago                             └────────┘│ │
│  └──────────────────────────────────────────────────────────┘ │
│                                                                │
...
│  评论 (3)                                                      │  ← 评论区域
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  👤 Alex Johnson                              15m ago    │ │
│  │  This is a worrying sign for the global supply chain.   │ │
│  │  Hope they can turn it around soon.                     │ │
│  └──────────────────────────────────────────────────────────┘ │
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  👤 Samantha Lee                              1h ago     │ │
│  │  Not unexpected, given the real estate crisis. The      │ │
│  │  government needs to inject more stimulus.              │ │
│  └──────────────────────────────────────────────────────────┘ │
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  👤 David Chen                                3h ago     │ │
...
| 分类 | 颜色标识 | 说明 |
|-----|---------|------|
| 全部 | 主题色(#1a90ff) | 默认选中，显示所有新闻 |
| 贵金属 | 主题色 | 黄金、白银等贵金属相关 |
| 外汇 | 蓝色 | 货币汇率相关 |
| 加密货币 | 紫色 | 比特币、以太坊等加密货币 |
| 宏观经济 | 默认色 | 央行政策、经济数据等 |
| 大宗商品 | 橙色 | 原油、天然气等大宗商品 |
...
资产组合模块帮助用户记录和管理个人持仓数据，包括资产组合详情页和记录持仓交易页。**注意：本功能仅用于记录持仓数据，不涉及真实交易资金往来。**
...
│  │  ─────────────────────────────────────────────────────── │ │
│  │  持仓量        持仓成本        最新市值 (¥)               │ │
│  │  50 oz        $2,100.00       856,200                   │ │
│  │  ┌──────────────────────────────────────────────────┐   │ │
│  │  │  浮动盈亏    +¥14,270.00              +13.5%     │   │ │  ← 盈亏显示(绿)
│  │  └──────────────────────────────────────────────────┘   │ │
│  └──────────────────────────────────────────────────────────┘ │
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  ┌────┐  现货白银                              >         │ │
...
│  │  ─────────────────────────────────────────────────────── │ │
│  │  持仓量        持仓成本        最新市值 (¥)               │ │
│  │  2000 oz      $29.50         403,800                    │ │
│  │  ┌──────────────────────────────────────────────────┐   │ │
│  │  │  浮动盈亏    -¥19,300.00              -4.5%      │   │ │  ← 盈亏显示(红)
│  │  └──────────────────────────────────────────────────┘   │ │
│  └──────────────────────────────────────────────────────────┘ │
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  ┌────┐  美元/人民币                           >         │ │
...
│  标的资产 Asset                                                │
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  🔍 搜索股票/基金/加密货币代码                            │ │  ← 资产搜索框
│  └──────────────────────────────────────────────────────────┘ │
│                                                                │
│  ┌────────────────────────┐  ┌────────────────────────┐      │
│  │  成交价格 Price         │  │  数量 Quantity         │      │
│  │  ┌──────────────────┐  │  │  ┌──────────────────┐  │      │
│  │  │ ¥ 0.00           │  │  │  │ 0                │  │      │
│  │  └──────────────────┘  │  └──────────────────┘  │      │
│  └────────────────────────┘  └────────────────────────┘      │
...
| 字段 | 说明 |
|-----|------|
| 总资产净值 | 所有持仓市值总和，以CNY计价 |
| 显示/隐藏按钮 | 点击可隐藏资产数值 |
| 今日盈亏 | 今日浮动盈亏金额和百分比 |
| 盈亏颜色 | 盈利绿色(#10b981)，亏损红色(#ef4444) |
...
|-----|------|
| 点击添加按钮 | 进入记录持仓交易页 |
| 点击显示/隐藏按钮 | 切换资产数值显示状态 |
| 点击筛选按钮 | 弹出筛选面板 |
| 点击分类chip | 筛选对应分类的持仓 |
| 点击排序下拉 | 切换排序方式(市值/盈亏/持仓量) |
| 点击持仓卡片 | 进入持仓详情页 |
| 点击智能识别 | 打开相机/相册选择图片 |
| 切换买入/卖出 | 切换交易类型，颜色变化 |
| 点击资产搜索框 | 弹出搜索面板 |
...
登录注册模块提供用户身份认证功能，支持手机号验证码登录和多种社交账号登录方式。
...
| 登录方式 | 说明 | 图标 |
|---------|------|------|
| 手机号登录 | 短信验证码登录，作为默认登录方式 | phone_iphone |
| Google登录 | OAuth第三方登录 | Google Logo |
| Apple登录 | Sign in with Apple | Apple Logo |
| 微信登录 | 微信OAuth登录 | 微信Logo(绿色) |
| TikTok登录 | TikTok OAuth登录 | TikTok Logo(黑色) |
...
|-----|------|
| 输入手机号 | 实时格式验证 |
| 点击获取验证码 | 发送验证码，按钮变为倒计时 |
| 点击登录按钮 | 验证表单，提交登录请求 |
| 点击社交登录图标 | 跳转对应OAuth授权页面 |
| 点击忘记密码 | 进入密码重置流程 |
| 点击立即注册 | 进入注册页面 |
| 登录成功 | 显示成功Toast，跳转首页 |
...
用户主页展示用户的公开资料、社交数据和发布内容，支持关注、私信等社交互动功能。
...
│  │  👤    │  Alex Morgan                                       │  ← 用户头像(圆形)
│  │ (头像) │                                                    │     80x80px
│  └────────┘  Value investor. Focusing on long-term             │  ← 用户简介
│              growth stocks and market analysis.                │
│                                                                │
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  ┌─────────────────────┐  ┌─────────────────────┐       │ │
│  │  │      关注 Follow     │  │    私信 Message     │       │ │  ← 操作按钮
│  │  │      (蓝色主色)      │  │    (灰色次要)       │       │ │
│  │  └─────────────────────┘  └─────────────────────┘       │ │
│  └──────────────────────────────────────────────────────────┘ │
│                                                                │
├────────────────────────────────────────────────────────────────┤
│                                                                │
│  150 关注    2,345 粉丝    1.2M 获赞                           │  ← 社交数据统计
│                                                                │
├────────────────────────────────────────────────────────────────┤
│  [发布的文章/话题] [评论] [关注的品种] [关注的用户]              │  ← Tab栏(可滚动)
│   ═══════════════                                              │     选中下划线
├────────────────────────────────────────────────────────────────┤
│                                                                │
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  Analysis on the recent market trends for Q3 2024        │ │  ← 文章卡片
│  │                                                          │ │
│  │  A brief excerpt from the article discussing key         │ │  ← 摘要(2行截断)
│  │  points and insights...                                  │ │
│  │                                                          │ │
│  │  Likes: 256, Comments: 32                        [图片]  │ │  ← 互动数据+缩略图
│  └──────────────────────────────────────────────────────────┘ │
│  ─────────────────────────────────────────────────────────────│
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  Deep Dive into the Semiconductor Industry's Future      │ │
│  │                                                          │ │
│  │  Exploring the next wave of innovation in chip           │ │
│  │  manufacturing and design...                             │ │
│  │                                                          │ │
│  │  Likes: 512, Comments: 68                        [图片]  │ │
│  └──────────────────────────────────────────────────────────┘ │
│  ─────────────────────────────────────────────────────────────│
│  ┌──────────────────────────────────────────────────────────┐ │
│  │  The Impact of AI on Traditional Banking                 │ │
│  │                                                          │ │
│  │  How artificial intelligence is reshaping customer       │ │
│  │  service, risk assessment...                             │ │
│  │                                                          │ │
│  │  Likes: 1,024, Comments: 128                     [图片]  │ │
│  └──────────────────────────────────────────────────────────┘ │
│                                                                │
└────────────────────────────────────────────────────────────────┘
```
...
- [ ] 用户信息卡片正确显示
- [ ] 支持手机号、Google、Apple、微信、TikTok五种账号绑定
- [ ] 个人资料可正常编辑保存
- [ ] 预测成绩卡片正确显示
- [ ] 我的预测记录页面正常展示
- [ ] 预测记录支持Tab筛选
